	...
	case 2:
			{
				...
				cout << "2. See Inventory\n";
				cout << "3. See Customer Data\n";
				choice = GetAndCheckInt(1, 3, "Please Enter Your Selection: ");
				switch(choice)
				{
				case 1: //Sales Data Options
					...
					break;
				case 2: 		//Inventory Data
						{
							cout << "What type of inventory data would you like to see?\n";
							cout << "1. Inventory List\n";
							cout << "2. Specific Item Information\n";
							choice = GetAndCheckInt(1, 2, "Please Enter Your Selection: ");
							switch(choice)
							{
							case 1: //Full List
								break;
							case 2: //Search by item
								break;
							default:
								break;
							}
